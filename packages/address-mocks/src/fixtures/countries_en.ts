import type {LoadCountriesResponse} from '@huckleberry-inc/address-consts';
  ...
  data: {
    countries: [
      ...
      },
      {
        ...
        formatting: {
          edit: '{lastName}{firstName}_{company}_{country}{zip}_{province}_{city}_{address1}_{address2}_{phone}',
